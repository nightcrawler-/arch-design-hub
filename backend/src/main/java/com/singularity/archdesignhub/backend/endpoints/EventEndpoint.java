...
import com.singularity.archdesignhub.backend.entities.Event;
...
public class EventEndpoint {
    ...
    @ApiMethod(
            ...
            path = "event",
            httpMethod = ApiMethod.HttpMethod.GET)
    public CollectionResponse<Event> list(@Nullable @Named("cursor") String cursor, @Nullable @Named("limit") Integer limit, @Nullable @Named("oldest") Long oldest) {
